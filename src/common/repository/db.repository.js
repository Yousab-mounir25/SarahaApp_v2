export const findById = async ({ id, options, model }) => {
  const doc = model.findById(id);
  if (options?.select) {
    doc.populate(options.select);
  }
  if (options?.populate) {
...
export const findOne = async ({ filter, options, model } = {}) => {
...
export const find = async ({ filter, options, model } = {}) => {
